...
<Admonition type="info" title="About this page">
This pages contains some background information on the topics of **speech intelligibility**, **hearing loss** and **objective measures**.
</Admonition>
...
- [HASQI and HASPI](https://pubmed.ncbi.nlm.nih.gov/29554034/) are quality and speech intelligibility metrics designed to work for people with a hearing impairment. [James Kates explains more about these above](../cpc1/taking_part/cpc1_faq/#speech-intelligibility). [MATLAB code HASPI v2 and HASQI v2](/data/HASPIv2_HASQIv2_HAAQIv1.zip) are available, along with the [user guide](/data/Users_Guide_ver3.zip).
