...
<img width="200" src={useBaseUrl('/img/CEC3/ear.png')} />
        </Grid>
       <Grid item xs={12} sm={6} md={4} key={item}>

<img width="200" src={useBaseUrl('/img/CEC3/glasses.png')} />
        </Grid>

</Grid>
<figcaption>Figure 5. Image showing the locations of the three hearing aid microphone.</figcaption>
</figure>
...
```text
- scenes.train.csv - metadata for the training scenes
