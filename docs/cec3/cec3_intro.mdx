...
Task 1 and 2 are now live. The data can be obtained from the [download page](./cec3_download) and full task descriptions are available on this site. For Task 3, the task description is now available and the data will be released very shortly.
:::
