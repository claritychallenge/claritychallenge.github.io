...
Task 1, 2 and 3 are now live. The eval data is now available obtained the [download page](./cec3_download) and full task descriptions are available on this site.
:::
