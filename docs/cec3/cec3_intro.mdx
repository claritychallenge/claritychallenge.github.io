...
- **30th March 2024**: Challenge launch with dataset and baseline software
- **25th July 2024**: Evaluation data released
- **1st Sept 2024**: 1st round [submission](./taking_part/cec2_submission) deadline for evaluation by objective measure

- **15th Sept 2024**: 2nd round [submission](./taking_part/cec2_submission) deadline for listening tests
