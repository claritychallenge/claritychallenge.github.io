...
## D. HASQI Speech Intelligibility model

Python implementation of the Hearing Aid Speech Quality Index (HASQI) model which is used for objective quality estimation. This will be used in the stage 1 evaluation of entrants (see Rules).
