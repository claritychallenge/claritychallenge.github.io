...
- **11th June**: Registration deadline. <FibreNew/>

- **15th June**: All entrants submit (i) audio for MBSTOI evaluation and (ii) a draft of their technical report (details below).
- **22nd June**: Deadline by which all entrants must submit two page technical reports to Clarity-2021 workshop (details below).  <FibreNew/>
