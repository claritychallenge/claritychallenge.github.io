...
Your processed signals should be named using the conventions used by the baseline system, i.e., `<Scene ID>_<Listener ID>_HA-output.wav` and explained on the [CEC1 data page](./cec1_data#d6-enhanced-signals).
