...
They will listen to an entrant’s sentence, respond verbally with what they think was said by the target talker, and then move on to the next sentence. Their response will be recorded by the tablet microphone(s) for scoring. Intelligibility will be evaluated as the number of words identified correctly in the sentence.
