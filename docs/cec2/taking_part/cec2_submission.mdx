...
:::info
All teams are [required to register](./cec2_registration) prior to submission and before the registration deadline August 28th.
:::
...
For the stage 2 listening test evaluation, there will be five listeners per scene and each team will have a separate scene-listener mapping. The file formats will be the same as used for the development data; for details see the [CEC2 Data](../data/cec2_data) page.
