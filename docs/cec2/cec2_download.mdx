...
- `clarity_CEC2_core.v1_0.tgz`  [**28 GB**] - metadata and dev set
- `clarity_CEC2_train.v1_0.tgz` [**69 GB**] - scenes for training systems
...
To unpack the data we recommend you follow the instructions in the Clarity Challenge GitHub repository.  See 


:::info
If you have any problems installing the software or downloading the data then please do not hesitate to [drop us an email](mailto:claritychallengecontact@gmail.com).
:::
