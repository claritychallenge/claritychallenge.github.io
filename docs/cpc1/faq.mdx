---
id: cpc1_faq
title: FAQ for Prediction Challenge
sidebar_label: FAQ
sidebar_position: 12
---
...
- [HASQI and HASPI](https://pubmed.ncbi.nlm.nih.gov/29554034/) are quality and speech intelligibility metrics designed to work for people with a hearing impairment. [James Kates explains more about these above](cpc1_faq/#speech-intelligibility). [MATLAB code HASPI v2 and HASQI v2](http://claritychallenge.org/wp-content/uploads/2021/10/HASPIv2_HASQIv2_HAAQIv1.zip) are available, along with the [user guide](http://claritychallenge.org/wp-content/uploads/2021/10/Users_Guide_ver3.zip).
