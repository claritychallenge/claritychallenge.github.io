...
const FeatureList = [{
        ...
        description: ( <
            >
            This site provides < a href = "./docs/cec2/intro" > full documentation < /a> of the
            challenge datasets, baseline systems and rules
            for participation. <
            />
        ),
    },
    ...
    },
    {
        ...
        description: ( <
            >
            All the code
            for the Clarity Challenge is open source and {
                " "
            } <
