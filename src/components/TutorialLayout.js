...
const TutorialList = [
    ...
    },
    {
        ...
        description: ( <
            >
            An explanation of the process used inside the evaluate
            function in the recipes folder.Covers loading audio, basic enhancement using NAL - R amplification and generating HASPI scores. <
            />
        ),
    },
    //    {
...
function Tutorial({
    ...
    return [ <
        ...
        li > {
            date
        } < CalendarIcon fontSize = "small" > < /CalendarIcon> <
        /li> <
        li >
        Difficulty: {
            difficulty
